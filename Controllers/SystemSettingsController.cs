...
namespace HelpDeskSystem.Controllers
{
    ...
    public class SystemSettingsController : Controller
    {
        ...
        public async Task<IActionResult> Create(SystemSetting systemSetting)
        {
            ...
            TempData["MESSAGE"] = "System Settings Details successfully added";
        ...
        public async Task<IActionResult> Edit(int id, SystemSetting systemSetting)
        {
            if (id != systemSetting.Id)
            {
                ...
                TempData["MESSAGE"] = "System Settings Details successfully updated";
                return RedirectToAction(nameof(Index));
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            TempData["MESSAGE"] = "System Settings Details successfully deleted";
            return RedirectToAction(nameof(Index));
        }
